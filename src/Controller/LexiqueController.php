...
class LexiqueController extends AbstractController
{
    ...
    public function lexique(): Response
    {
        $lexique = [
            'A' => [
                'Acerbe' => 'Qui est d\'un goût aigre et âpre. Se dit d\'un vin acide, dur et âpre. Goût mordant souvent lié à une note végétale (macération de rafles vertes en vinification rouge), vendange peu mûre.',
                ...
                'A.O.C' => 'Appellation d’origine contrôlée. désigne des produits répondant aux critères de l\'AOP et protège la dénomination sur le territoire français. Elle constitue une étape vers l\'AOP, désormais signe européen.',
            ...
            'B' => [
                'Blanc de blancs' => 'Le Blanc de Blancs, ou Blanc de Blanc, est un vin effervescent produit exclusivement avec des raisins blancs. Cette dénomination tient son origine dans la couleur du champagne obtenue à partir de raisins blancs, généralement du chardonnay.',
                'Blanc de noirs' => 'Le blanc de noirs est un vin blanc produit avec des raisins rouges ou noirs, à jus blanc. Les champagnes utilisent cette dénomination pour les vins issus exclusivement des cépages pinot noir ou pinot meunier ou les deux en assemblage. Ils sont caractérisés par la force du premier et/ou le fruité du second (ex: pinot).',
                ...
                'Bouquet' => 'Le bouquet d\'un vin désigne la richesse olfactive d\'un vin à maturité. Le bouquet met du temps à se construire en bouteille, et il est rapidement détruit par exposition à l\'air. ',
            ],

            'C' => [
                'Caudalie' => 'Unité de mesure de la persistance aromatique (1 caudalie = 1 seconde). C\'est à dire le nombre de secondes pendant lesquelles après avoir avalé ou craché le vin, il donne encore une impression complète en bouche.',
                ...
                'Chair' => 'La description de la chair correspond à la consistance de la matière du vin. On attend d\'un vin de « qualité » que sa matière, sa chair, soit harmonieuse et équilibrée par rapport à sa charpente, à son squelette, et à sa puissance.',
            ...
            'M' => [
                ...
                'Mutage' => 'Le mutage a pour but de conserver au moût une partie de ses sucres en arrêtant la fermentation alcoolique par addition d\'alcool neutre. Le mot vient du terme muter signifiant rendre muet en vieux français, car l\'opération stoppe également le bruit caractéristique de la fermentation.',
            ],
