    ...
    public function lexique(): Response
    {
        $lexique = [
            'A' => [
                ...
                Goût mordant souvent lié à une note végétale (macération de rafles vertes en vinification rouge), vendange peu mûre.',
                'Acidité' => 'Le vin est une boisson alcoolisée et acidulée. L\'acidité est un élément essentiel du vin. 
                Elle est présente dans le raisin, elle participe à donner de la fraîcheur et de la vigueur au vin, en excès, elle donne de la verdeur. 
                Si le vin manque d\'acidité, on dit qu\'il est mou.',
                'Alcooleux' => 'Se dit d\'un vin qui par un excès d\'alcool rend un vin légèrement déséquilibré. 
                Pour gommer le coté chaleur (thermique) nous prendrons la précaution de servir le vin 1 à 2 degrés plus bas qu\'à l\'habitude.',
                ...
                'A.O.C' => 'Appellation d’origine contrôlée. désigne des produits répondant aux critères de l\'AOP 
                et protège la dénomination sur le territoire français. Elle constitue une étape vers l\'AOP, désormais signe européen.',
                ...
                'Arôme' => 'Odeur(s) d\'un vin. On distingue les arômes primaires (propres au cépage),
                secondaires (provenant de la fermentation) et tertiaires (liés à l\'évolution du vin en milieu réducteur)',
            ],

            'B' => [
                'Blanc de blancs' => 'Le Blanc de Blancs, ou Blanc de Blanc, est un vin effervescent produit exclusivement avec des raisins blancs. 
                Cette dénomination tient son origine dans la couleur du champagne obtenue à partir de raisins blancs, généralement du chardonnay.',
                'Blanc de noirs' => 'Le blanc de noirs est un vin blanc produit avec des raisins rouges ou noirs, à jus blanc. 
                Les champagnes utilisent cette dénomination pour les vins issus exclusivement des cépages pinot noir ou pinot meunier ou les deux en assemblage. 
                Ils sont caractérisés par la force du premier et/ou le fruité du second (ex: pinot).',
                'Botrytisé' => 'Se dit d\'un vin issu de raisins affectés par la pourriture noble, c\'est à dire par la forme la plus bénéfique du Botrytis.
                Les vins botrytisés sont dits liquoreux.',
                'Bouquet' => 'Le bouquet d\'un vin désigne la richesse olfactive d\'un vin à maturité. 
                Le bouquet met du temps à se construire en bouteille, et il est rapidement détruit par exposition à l\'air. ',
            ],
            ...
            'C' => [
                ...
                Identité de chaque variété de raisins, on distingue les raisins de table consommés en l\'état, 
                les raisins de cuve permettant d\'élaborer un vin.',
                'Chai' => 'Local où se déroulent les vinifications et/ou l’élevage du vin.',
                'Chair' => 'La description de la chair correspond à la consistance de la matière du vin.
                On attend d\'un vin de « qualité » que sa matière, sa chair, soit harmonieuse et équilibrée par 
                ...
                'Collage' => 'Opération consistant à faire précipiter dans une cuve ou une barrique des particules en suspension jugées indésirables dans le vin.
                On emploie pour cela du blanc d\'œuf, de la caséine...',
                'Coulure' => 'Non-transformation de la fleur de vigne en fruit en raison d\'une mauvaise fécondation, 
                pouvant s\'expliquer par des raisons diverses (climatiques, physiologiques).',
            ],

            'D' => [
                'Débourbage' => 'Opération consistant à éliminer les particules solides (pépins, morceaux de rafle...) 
                ...
                'Dormance' => 'Période hivernale, lorsque les premiers froids (fin de l\'automne et début de l\'hiver) endorment la vigne. 
            ...
            'F' => [
                'Fermentation alcoolique' => 'Transformation du sucre contenu dans le raisin en alcool sous l’effet des levures. 
            ...
            'M' => [
                'Madérisé' => 'Se dit d\'un vin oxydé, c\'est à dire ayant subi un long contact avec l\'oxygène 
                ...
                'Mildiou' => 'Champignon microscopique s\'attaquant à la face interne des feuilles de vignes.
                Elles finissent par tomber. On lutte contre le mildiou avec la bouillie bordelaise (mélange de chaux et de cuivre).',
                ...
                'Moût' => 'Jus du raisin non fermenté. Constitué d\'éléments solides (fragments de peaux ou pellicule, de rafles) 
                et d\'éléments liquides (eau, sucres, acides, etc.). Il est la base du futur vin.',
                'Mutage' => 'Le mutage a pour but de conserver au moût une partie de ses sucres en arrêtant 
                la fermentation alcoolique par addition d\'alcool neutre. Le mot vient du terme muter signifiant rendre muet en vieux français, 
            ...
            'O' => [
                'Oenologue' => 'Technicien du vin dont les connaissances sont sanctionnées par un diplôme national, 
                le D.N.O. Ce mot est souvent utilisé à tort, et confondu avec œnophile (amateur de vin) voire d\'autres professions du vin comme 
            ...
            'P' => [
                ...
                'Phénolique' => 'Composant du vin (tanins, matières colorantes...) jouant un rôle déterminant dans la couleur,
            ...
            'R' => [
                ...
                qui dans des conditions idéales transforme les grains en apparence comme en profondeur et fait naître les plus grands vins liquoreux.',
            ...
            'V' => [
                'Véraison' => 'Étape du cycle végétatif de la vigne qui voit les pellicules de raisins acquérir 
